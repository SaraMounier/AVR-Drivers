...
const DIO_strPinCnfg_t DIO_strPinCnfg [32]=
{
	...
	/*PIN10*/{DIO_DIR_INPUT,    DIO_INPUT_PULL_DOWN },
	/*PIN11*/{DIO_DIR_INPUT,    DIO_INPUT_PULL_DOWN },
	/*PIN12*/{DIO_DIR_INPUT,    DIO_INPUT_PULL_DOWN },
	/*PIN13*/{DIO_DIR_INPUT,    DIO_INPUT_PULL_DOWN },
	/*PIN14*/{DIO_DIR_INPUT,    DIO_INPUT_PULL_DOWN },
	/*PIN15*/{DIO_DIR_INPUT,    DIO_INPUT_PULL_DOWN },
	/*PIN16*/{DIO_DIR_INPUT,    DIO_INPUT_PULL_DOWN },
	...
	/*PIN26*/{DIO_DIR_INPUT,    DIO_INPUT_PULL_DOWN },
	/*PIN27*/{DIO_DIR_INPUT,    DIO_INPUT_PULL_DOWN },
