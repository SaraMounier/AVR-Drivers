...
{
	[LCD_GND 	]={.LCD_PortNum=LCD_CONTROL_PORT , .LCD_PinNum=DIO_enuPin0 , .LCD_Initial_Value=LOW },
	[LCD_VDD 	]={.LCD_PortNum=LCD_CONTROL_PORT , .LCD_PinNum=DIO_enuPin1 , .LCD_Initial_Value=LOW },
	[LCD_VO  	]={.LCD_PortNum=LCD_CONTROL_PORT , .LCD_PinNum=DIO_enuPin2 , .LCD_Initial_Value=LOW },
	[LCD_RS_PIN ]={.LCD_PortNum=LCD_CONTROL_PORT , .LCD_PinNum=DIO_enuPin3 , .LCD_Initial_Value=LOW },
	[LCD_RW_PIN ]={.LCD_PortNum=LCD_CONTROL_PORT , .LCD_PinNum=DIO_enuPin4 , .LCD_Initial_Value=LOW },
	[LCD_EN_PIN ]={.LCD_PortNum=LCD_CONTROL_PORT , .LCD_PinNum=DIO_enuPin5 , .LCD_Initial_Value=LOW },
	[LCD_D0_PIN ]={.LCD_PortNum=LCD_DATA_PORT 	 , .LCD_PinNum=DIO_enuPin0 , .LCD_Initial_Value=LOW },
	[LCD_D1_PIN ]={.LCD_PortNum=LCD_DATA_PORT 	 , .LCD_PinNum=DIO_enuPin1 , .LCD_Initial_Value=LOW },
	[LCD_D2_PIN ]={.LCD_PortNum=LCD_DATA_PORT 	 , .LCD_PinNum=DIO_enuPin2 , .LCD_Initial_Value=LOW },
	[LCD_D3_PIN ]={.LCD_PortNum=LCD_DATA_PORT 	 , .LCD_PinNum=DIO_enuPin3 , .LCD_Initial_Value=LOW },
	[LCD_D4_PIN ]={.LCD_PortNum=LCD_DATA_PORT 	 , .LCD_PinNum=DIO_enuPin4 , .LCD_Initial_Value=LOW },
	[LCD_D5_PIN ]={.LCD_PortNum=LCD_DATA_PORT 	 , .LCD_PinNum=DIO_enuPin5 , .LCD_Initial_Value=LOW },
	[LCD_D6_PIN ]={.LCD_PortNum=LCD_DATA_PORT 	 , .LCD_PinNum=DIO_enuPin6 , .LCD_Initial_Value=LOW },
	[LCD_D7_PIN ]={.LCD_PortNum=LCD_DATA_PORT 	 , .LCD_PinNum=DIO_enuPin7 , .LCD_Initial_Value=LOW },
	[LCD_BLA_PIN]={.LCD_PortNum=LCD_CONTROL_PORT , .LCD_PinNum=DIO_enuPin6 , .LCD_Initial_Value=LOW },
	[LCD_BLK_PIN]={.LCD_PortNum=LCD_CONTROL_PORT , .LCD_PinNum=DIO_enuPin7 , .LCD_Initial_Value=LOW }
};
